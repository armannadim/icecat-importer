...
import static com.christian.icecat.configProperties.properties;
...
public class CommandLineView {
    ...
    public void run() {
        ...
        /*NADIM Added to get the category list from the properties file*/
        ParsingController.setCatList(Arrays.asList(properties.getProperty("catList").split(",")));
        /*END NADIM */
    ...
    private void numberOfProductsToImport(IcecatProductsImporter importer) {
        ...
        System.out.format(Messenger.TOTAL_NUMBER_OF_PRODUCTS, numberOfProducts);
        ...
        String nrStr = properties.getProperty("number");
        try {
            newSize = Integer.parseInt(nrStr);
    ...
    private HibernateConnector connectToDatabase() {
        ...
        String dbPwd = properties.getProperty("DB_PASSWORD");
    ...
    private boolean testConnection(Connectable connector) {
        ...
        Connectable connectable = connector;
        try {
    ...
    private AbstractIcecatConnector connectToIcecat() {
        ...
        String icecatUser = properties.getProperty("ICECAT_USERNAME");
        String icecatPassword = properties.getProperty("ICECAT_PASSWORD");
        String icecatUrl = properties.getProperty("ICECAT_URL_STR");
